...
from sklearn.metrics import roc_auc_score, roc_curve, brier_score_loss, precision_recall_curve, average_precision_score, auc
...
prop_cycle = (
    cycler(
        ...
        'linestyle',
        [(0, ()), (0, (1, 5)), (0, (1, 1)), (0, (5, 5)), (0, (5, 1)), (0, (3, 5, 1, 5)), (0, (3, 1, 1, 1))]
    )
)
